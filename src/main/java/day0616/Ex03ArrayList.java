...
public class Ex03ArrayList {
    public static void main(String[] args) {
        ...
        // 2. 해당 어레이리스트에 몇개의 객체가 존재하는지 체크하고 싶다면?
        System.out.println("size(): " + list.size());

        // 3. 해당 어레이리스트의 가장 마지막에 새로운 요소를 추가하고 싶다면?
        ...
        // 4. list 의 특정 인덱스 값에 저장된 객체를 불러올 때에는?
        System.out.println("get(1): " + list.get(1));

        // 5. list 의 특정 위치에 새로운 객체를 끼워넣을 때에는?
        list.add(1, 200);
        System.out.println("get(1): " + list.get(1));

        // 6. list 의 특정 인덱스의 값을 삭제할 때에는?
        list.remove(1);
        System.out.println("get(1): " + list.get(1));

        // 7. list 의 전체 내용을 삭제할때에는?
        list.clear();
        System.out.println("isEmpty(): " + list.isEmpty());

        // 아래의 메소드들은 정확한 결과를 받기 위해서는
        // 반드시 해당 클래스 안에 equals 메소드가
        // 정확하게 오버라이드 되어 있어야 한다.
